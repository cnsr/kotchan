...
var check_permissions = require('../utils/check-permissions');
...
app.post('/chat/:id([a-z0-9]+)', upload.array("image", "recording"), function (req, res, next) {
    ...
    async.series([
        ...
        check_permissions.bind(null, req, res),
	    ...
	    chat.body = chat.body.replaceAll("nigger", "person of color");
            if (data.image) {
...
app.get('/:id([a-z0-9]+)', function (req, res) {
    console.log('redirecting the id:', req.params.id)

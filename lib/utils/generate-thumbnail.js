...
module.exports = function(data, callback) {
	...
	/*
	data.t_width = thumb_width;
	data.t_height = thumb_height;
	*/

        console.log(thumb_base_name);
        ...
        /*if (category === "image") {
            command = 'convert';
            args = (
                '-[0]'+(extension === 'gif' ? ' -layers coalesce' : '')+' -thumbnail '+thumb_width+'x'+thumb_height+'! -strip -auto-orient'+

...
$(document).ready(function() {
    if(!localStorage['stickers']) localStorage['stickers']=JSON.stringify(stickers.slice(0,50));
...
function list_stickers(){
    ...
    $('.sticker').remove();
    $(last_stickers.slice(0,15)).each(function(i, val){
...
function put_sticker(val){
    ...
    if(last_stickers.length>50) last_stickers.pop();
